...
- [x] E10: Чернильный outline крупных зданий на всех картах (Visual_Coherence_Pass п.10, OQ4=да) — inverted-hull шеллы (shared-материал 0.06 м, та же дистанционная компенсация), только несущие wall-корпуса выше порога (max(w,d)≥8 или h≥8 при h≥4), ≤2 шелла на корпус (масса+крыша), мелочь/скайлайн мимо; census factory 545→601 / village 790→860 / city 484→532 (все <+15% DC); пины `buildingInk.test.ts` (+13), GDD [[Stylized_Art_Direction]] §13.
