...
function stubContext(): TankBuildContext {
  return {
    ...
    trackLeftTex: null as unknown as THREE.CanvasTexture,
    trackRightTex: null as unknown as THREE.CanvasTexture,
    trackLeftMat: new THREE.MeshStandardMaterial(),
    trackRightMat: new THREE.MeshStandardMaterial(),
