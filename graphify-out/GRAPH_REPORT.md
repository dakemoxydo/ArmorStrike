...
## Corpus Check
- 275 files · ~103,666 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1800 nodes · 4383 edges · 133 communities (84 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14eeb3ae`
...
Cohesion: 0.16
Nodes (16): bakeSweep(), cacheByCanvas, CanvasCache, drawMinimap(), getCache(), MAP_HALF, MAP_SIZE, paintStatics() (+8 more)

### Community 6 - "physics.ts"
Cohesion: 0.06
Nodes (48): WeaponType, AIBody, AIController, AICtx, AIPersona, AIState, AITarget, DEFAULT_PERSONA (+40 more)

### Community 7 - "TurretId"
Cohesion: 0.17
Nodes (9): HullId, TurretId, buildPlayerStyle(), TankStyle, GarageBinding, RosterSpawnCtx, TankBuildInput, RunState (+1 more)
...
Cohesion: 0.09
Nodes (25): HudCrosshair(), HudCrosshairProps, FeedEntry, HudFeed(), HudFeedProps, HudProps, HudRadar(), HudRadarProps (+17 more)
...
Cohesion: 0.18
Nodes (4): GameSimulation, GameModeControllerDeps, GarageBindingDeps, GameEvent
...
Cohesion: 0.13
Nodes (20): React 19, BootError(), BootErrorProps, Garage(), GarageProps, HUD(), HullCard(), HullCardProps (+12 more)
...
Cohesion: 0.14
Nodes (9): COLORS, _bd, _bv, PhysicsSystemStage, MinimapSystem, PhysicsSystem, KillStreakTracker, STREAK_LABELS (+1 more)
...
### Community 46 - "HudScoreboard.tsx"
Cohesion: 0.36
...
### Community 52 - "GameLoop.ts"
Cohesion: 0.15
Nodes (3): TimeScale, GameLoop, GameLoopDeps
...
Cohesion: 0.27
Nodes (10): GameOverScreen(), GameOverScreenProps, MatchEndReason, formatKd(), formatMatchClock(), modeLabelRu(), resultsHeadline(), ResultsHeadlineInput (+2 more)

### Community 57 - "GameApi"
Cohesion: 0.20
...
### Community 59 - "renderWorldQuality.test.ts"
Cohesion: 0.33
...
### Community 64 - "Arena & Physics — Арена и коллизии"
Cohesion: 0.33
...
### Community 66 - "disposeObject3D"
Cohesion: 0.21
Nodes (8): disposeObject3D(), isShared(), markShared(), Shared, AssetManager, cloneWithOwnMaterials(), matsOf(), texturesOf()
...
Cohesion: 0.11
Nodes (21): BARREL_REST_Y, tmpDir, tmpMuzzle, fillMuzzleAndAim(), applyRailgunChargingFx(), applyRailgunCooldownChargeFx(), applyRailgunIdleChargeFx(), tmpDir (+13 more)
...
### Community 74 - "stages/index.ts"
Cohesion: 0.25
Nodes (9): BotRoster, buildSimulationStages(), StageDeps, PlayerInputStage, NameplateMap, ScalarCell, SimSystem, MatchStage (+1 more)
...
Cohesion: 0.15
Nodes (14): BASE, configForMode(), DEFAULT_MATCH_MODE, MatchRuntime, MatchRuntimeHooks, MatchConfig, MatchResult, TankMatchStats (+6 more)

### Community 79 - "TeamId"
Cohesion: 0.20
Nodes (13): allyLineBlockers(), FocusCandidate, FocusSelf, isLineBlocker(), pickAiFocus(), PickAiFocusOpts, PickAiFocusResult, TeamId (+5 more)

### Community 82 - "PlayerFactory.ts"
Cohesion: 0.10
Nodes (6): despawn(), ProjectileManager, WeaponFactoryDeps, FlamethrowerWeapon, Weapon, WeaponDeps

### Community 83 - "ArmorStrike — Autonomous Progress Log"
Cohesion: 0.29
Nodes (6): ArmorStrike — Autonomous Progress Log, Baseline (recorded 2026-08-24, iter #1), Iteration 1 — 2026-08-24 · [A] BUGS & STABILITY, Iteration 2 — 2026-08-24 · [J] CODE QUALITY, Micro-reflection (iter 1), Micro-reflection (iter 2)
...
### Community 98 - "CombatSystem"
Cohesion: 0.29
Nodes (3): CombatDeps, CombatSystem, ProjectileStage

### Community 99 - "RespawnController.ts"
Cohesion: 0.25
Nodes (8): applyRespawnCombat(), canRespawn(), Respawnable, FFA_FALLBACK, RespawnController, RespawnHooks, restoreDeathVisuals(), respawnPoolFor()

### Community 100 - "BotAiStage.ts"
Cohesion: 0.27
...
### Community 101 - "Collider"
Cohesion: 0.12
Nodes (6): Collider, _wctx, WeaponHost, railgunShouldStartCharge(), RailgunWeapon, CombatPeer
...
### Community 103 - "Arena"
Cohesion: 0.14
Nodes (4): Arena, disposeArenaSubtree(), MinimapStage, HudModel
...
Cohesion: 0.14
Nodes (16): TankBuildContext, buildHull(), normalizeHullModel(), prepareTexturedModel(), HULL_CONFIG, HULL_TURRET_Y, MODEL_HULL_TARGET_LENGTH, MODELS_ENABLED (+8 more)

### Community 118 - "game/constants.ts"
Cohesion: 0.31
