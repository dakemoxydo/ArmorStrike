...
## Платформенные ограничения (Desktop Only)

Игра строго сфокусирована на **десктопном опыте**:
- **Ввод:** Физическая клавиатура (WASD / стрелки, Shift, пробел, R, Tab, Esc) и мышь с поддержкой Pointer Lock API.
- **Мобильные платформы:** Тач-скрины, экранные джойстики и эмуляция тача намеренно не поддерживаются (архитектурное решение K3). Дизайн боёвки и наведения башни сбалансирован под мышиное позиционирование и точный контроль гусениц с клавиатуры.
