...
Layout `{ barrelY: 0.46, muzzleZ: 1.64 }`; бюджет остаётся в тестовой
вилке 600–20000 вершин; габариты башни L×W×H ≈ 4.0 × 2.4 × 1.1.

- **Корпус:** низкая органичная «пасть» по референсу Tanki Online: скруглённое
  основание, купол-корма, вздутый центральный гребень, два длинных сплюснутых
  клыка-капсулы (~45% длины) с гладким выпуклым верхом и наружной окантовкой.
  Купола, оптики и дымовых шашек нет —
  силуэт читается клыками, гребнем и «бровью».
- **Воздухозаборник:** чёрная ниша на гребне, боковые рельсы-рамки,
  гребёнка из 4 продольных волнистых рёбер и крышка ската спереди.
- **Бортовые «глаза»:** на самой широкой части скулы, утоплены в тело клыка:
  скошенная тёмная рама + `rail`-вставка (пульс режима луча) и короткая янтарная
  `lamp`-риска. По внутреннему
  ребру клыка — `rail`-кондуит, «ниточка» энергии ведёт к пасти.
- **Пасть:** тёмные стенки и дно в передней части щели; в центре — пульсирующее
  нано-ядро (`rail`-эллипсоид) и `lamp`-зрачок за ним; над пастью —
  металлическая «бровь»-мост, скрепляющая клыки, с тёмными «ноздрями».
- **Корма:** металлический транец утоплен в купол, расклешённые бёдра,
  по 3 тёмные жалюзи на бедро и боковые оранжевые `lamp`-огни.
- **«Клешни вместо ствола»:** ствола-трубы НЕТ. В `barrelGroup` у каждой стороны
  два горизонтальных гранёных сегмента (`SphereGeometry(…, 6, 4)`), которые
  последовательно смещаются к центру. Тёмные наконечники направлены во внутреннюю
  щель; между клешнями оставлено только простое тёмное седло без накопительного шара.
  Мuzzle — у кончиков клешней (`muzzleZ 1.64`).
- **`rail`-слот** заполняют бортовые вставки, кондуиты, нано-ядро и кристаллы
  ⇒ `railGlowMat` существует (инвариант в `turretGeometry.test.ts`).
