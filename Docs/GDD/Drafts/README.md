...
- [[Visual_Coherence_Pass]] — подогнать мир/свет/FX/UI-остатки под комикс/cel. Срез 1 shipped (циан, IBL/bloom, земля, трассер Смоки, неймплейты) + ink зданий (2026-09-21) + срез 2 (2026-09-23: небо, город day comic, остовы, подиум). Открыто: п.8 деревня-текстуры, п.12 импакт, п.14 смерть по оружию, п.15 щит респавна, п.17 рим-свет гаража.
