...
**Код:** `src/game/shaders/celShading.ts`, `src/game/tank/comicInkOutline.ts`, `src/game/tank/TankFactory.ts`, `src/game/atmospherePresets.ts`
...
1. **Ступенчатое квантование рассеянного света (Cel-Shading)** на стандартных материалах.
...
гарантирует, что WebGLRenderer переиспользует единую скомпилированную программу для всех стилизованных материалов танка.

---

## 3. Чернильный контур (`comicInkOutline`)
...
## 4. Бюджет и инварианты производительности
